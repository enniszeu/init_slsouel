...
class Vanphong extends React.Component{
  constructor(props){
            super(props);
  ...
  render(){
    ...
    var showTable = productsSp.map((product, index)=>{
            return ( 
                <div className="col-xs-12 col-sm-4 col-md-4 col-lg-4" id={(product.conten === "Văn phòng phẩm") ? " display_man" : "display_yi"} key={index}>
